...
# TASK - To create Game of Connect Four with a slight twist!
# We will support the traditional, 6 x 7 board
...
# Check specified num of pieces of player1 or player2 connected vertically
def checkVertically():
    # Player 1:
    c_lis = []
    r_lis = []
...
# Check specified num of pieces of player1 or player2 connected Horizontally
...
# Check specified num of pieces of player1 or player2 connected Diagonally
def checkDiagonally():
    # Player 1:
    count = 0
    r_lis = []
...
# Check pieces connected vertically/horizontally/diagonally
def checkResult():
    res=checkVertically()
    if res == 1:
        print("Player 1 Win")
...
# Get the row,column,pieces,player 1 color and player 2 color values
def initial():    
